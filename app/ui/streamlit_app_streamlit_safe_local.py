...
from app.services.search_service_streamlit_safe import process_dataframe_streamlit_safe


st.set_page_config(page_title="Busca de profissionais", layout="wide")

st.title("Busca de profissionais por conselho")
st.caption("Versão Streamlit-safe para Windows, usando subprocesso por consulta.")
