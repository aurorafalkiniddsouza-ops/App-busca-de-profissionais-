...
from app.services.search_service_streamlit_file_safe import process_dataframe_streamlit_safe


st.set_page_config(page_title="Busca de profissionais", layout="wide")

st.title("Busca de profissionais por conselho")
st.caption("Versão file-safe para Windows, usando subprocesso + arquivo JSON por consulta.")
