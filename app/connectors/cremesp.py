...
class CremespConnector(BaseCouncilConnector):
    council_name = "CREMESP"

    async def search_by_name(self, full_name: str, state: str | None = None) -> list[dict[str, Any]]:
        """
        Scaffold inicial.
        Substituir por automação real com Playwright após mapeamento do portal.
        """
        return []
    ...
    def parse_result(
        ...
        return {
            ...
            "evidence_note": raw_item.get("evidence_note", "Consulta inicial CREMESP"),
