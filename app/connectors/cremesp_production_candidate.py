...
class CremespProductionCandidateConnector(BaseCouncilConnector):
        ...
        async with async_playwright() as playwright:
            ...
            try:
                ...
                for row in candidate_rows:
                    ...
                    parsed["evidence_note"] = "Resultado capturado por conector candidato de produção do CREMESP."
                    parsed["notes"] = "Conector validado com parsing estruturado para nome, status e CRM."
